...
# Lines 19 through 26 create the plot. The df.columns label the two columns in the file to be set as x and y values. The plt.plot plots the columns on an x-axis and a y-axis. Lines 21 and 22 create the labels for the x and y axis. A specific part of the plot is zoomed in by using the xlim and ylim to define the start and stop point of the x- and y-axis. The plot is given the title of Methyl Stearate Peak and is told to show the plot. 
